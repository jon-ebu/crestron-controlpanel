...
<style>
  * {
  ...
  .group Button {
    width: 80px; /* Match the size of VolumeSlider buttons */
    height: 80px; /* Match the size of VolumeSlider buttons */
    font-size: 1.5rem; /* Adjust font size for larger buttons */
    display: flex;
    justify-content: center;
    align-items: center;
    background-color: #f0f0f0;
